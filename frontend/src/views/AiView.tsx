      ...
      {activeTab === 'weekly' && (
        <div className="card" style={{ borderTop: '2px solid var(--neon-blue)', borderRadius: '0 4px 4px 4px' }}>
          <div style={{ display: 'flex', gap: 8, marginBottom: 12 }}>
            ...
            <button className="btn" type="button" onClick={() => copy(weeklyDraft, setCopiedWeekly)} disabled={!weeklyDraft}>复制</button>
            <button className="btn" type="button" onClick={() => download(weeklyDraft, 'weekly-report')} disabled={!weeklyDraft}>下载</button>
      ...
      {activeTab === 'progress' && (
        <div className="card" style={{ borderTop: '2px solid #00ff88', borderRadius: '0 4px 4px 4px' }}>
          <div style={{ display: 'flex', gap: 8, marginBottom: 12, alignItems: 'center' }}>
            ...
            <button className="btn" type="button" onClick={() => copy(progressDraft, setCopiedProgress)} disabled={!progressDraft}>复制</button>
            <button className="btn" type="button" onClick={() => download(progressDraft, 'progress-report')} disabled={!progressDraft}>下载</button>
